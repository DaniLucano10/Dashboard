    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="text-white bg-secondary-100 p-8 rounded-xl shadow-[0px_0px_25px_#bbf7d0] w-auto lg:w-[400px]">
        ...
        <form className="mb-8">
          ...
          <div>
            <button type="submit" className="bg-primary w-full text-white uppercase font text-sm py-3 px-4 rounded-lg hover:text-gray-100 transition-colors">
              Ingresar
            </button>
          </div>
        </form>
        <div className="flex flex-col items-center gap-4 ">
          <Link to="/olvide-password" className="hover:text-primary transition-colors">
            ¿Olvidaste tu contraseña?
          </Link>
          <span className="flex items-center gap-2">
            ¿No tienes cuenta? 
            <Link to="/registro" className="text-primary/90 hover:text-gray-100 transition-colors">
              Registrate
            </Link>
          </span>
        </div>
